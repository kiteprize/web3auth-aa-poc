...
/**
 * A sample factory contract for MyAccount
...
contract MyAccountFactory {
    ...
    constructor(IEntryPoint _entryPoint) {
        accountImplementation = new MyAccount(_entryPoint, address(0));
     ...
     */
    function createAccount(address owner,uint256 salt) public returns (MyAccount ret) {
        ...
        ret = MyAccount(payable(new ERC1967Proxy{salt : bytes32(salt)}(
                ...
                abi.encodeCall(MyAccount.initialize, (owner))
            )));
    }
